...
<div> <input type="text" class="balloon"  placeholder="New Password" data-required="1" name="password" id="password" ><label for="name"><i class="fa fa-lock"></i></label></div>
<div> <input type="text" class="balloon" placeholder="Confirm Password" data-required="1"  name="cpassword" id="cpassword" ><label for="name"><i class="fa fa-lock"></i></label></div>
