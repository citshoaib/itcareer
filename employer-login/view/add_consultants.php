...
<form id="theform" name="randform" method="post" action="?page=create" enctype="multipart/form-data">
                        <table width="50%" cellpadding="10" class="table table-striped">
							...
							<tr>
							  <td>Upload CV:</td>
							  <td><input type="file" required="" title="file" accept=".doc, .docx"  id="cv" name="cv"> Only .doc, .docx  file
							...
							<tr id="submit">
							  ...
							  <td>
									...
									<input type="submit" id="submit"  value="Save" class="btn btn-active btn-custom btn-rounded waves-effect waves-light" name="submit">
							</td></tr>
                        </tbody></table>
