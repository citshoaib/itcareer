...
$select=mysql_query("select a.id,a.operator_id,a.email,b.first_name,b.middel_name,b.last_name from sedna_operator_request_consultants_reg a left join sebna_profile_tbl b on a.id=b.reg_id where a.id=$oprater_id");
$fetch=mysql_fetch_array($select);
$email= $fetch['email'];
 $first_name=$fetch['first_name'];
 $middel_name=$fetch['middel_name'];
 $last_name=$fetch['last_name'];
 //echo $oprater_id=$fetch['id'];
  $consultant_id=$fetch['operator_id'];
...
<div class="row ">
        ...
        <div class="col-lg-12 bg">
            ...
            ?></h4>
          <?php $select_data=mysql_query("select * from sedna_comment_table where consultant_id=$oprater_id order by id desc");
