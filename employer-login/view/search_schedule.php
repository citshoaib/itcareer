...
<div class="row ">
           ...
           <?php
		$session_email=$_SESSION["employer_email"];
           $JobId = $_GET['JobId'];
           ...
           ?>
            ...
            <form method="post" action="model/search_schedule_model.php" enctype="multipart/form-data">
            ...
            <div class="row">
				...
				<input type="hidden" name="session_email" value="<?php echo $session_email;?>">
