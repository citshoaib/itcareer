...
<!--?page=employer-->
         ...
         <div class="row ">
         <div class="col-md-9">
         <h3><i>Advanced Candidate Search</i></h3>
         ...
         <script>
            ...
            var key_select=$("#keyselect option:selected" ).val();
             ...
             localStorage.setItem('company_name_local', company_name);
              ...
              var skill_set=$("#skill_set option:selected" ).val();
              localStorage.setItem('skill_set_local_key', skill_set);
               var skill_name= $("#skill_name").val();
             localStorage.setItem('skill_name_local', skill_name);
		...
		var key_word_local= localStorage.getItem('key_word_local');
         ...
         <div class="row pt_10">  
         <div class=" col-md-4"><select class="form-control mt_5" id="keyselect" name="keyword_set">
         ...
         <input name="skill_name[]" class="form-control" id="skill_name" type="text">
         ...
         <div class="input col-md-3">
         <select class="form-control" id="company_set" name="company_set">
         <option value="All">All</option>
         ...
         <div class="input">
         <div class="form-group form-md-line-input form-md-floating-label has-success">
         <input name="company_name" value="" id="company_name" class="form-control" type="text">
         ...
         <div class="input col-md-3">
         <select class="form-control" id="job_title_set" name="job_title_set">
         <option value="All">All</option>
         ...
         <div class="input">
         <div class="form-group form-md-line-input form-md-floating-label has-success">
         <input name="work_feild" value="" id="work_feild" class="form-control" type="text">
         ...
         <div class="row pt_10">          <div class=" col-md-1"><div class="input pall">
         ...
         <?php
         $select_state=$conn->query("select * from state_master");
         while($fetch_state=$select_state->fetch_array())
         {
         ?>
         ...
         <div class="pt_15">
         <input class="btn btn-default-1 btn-custom btn-rounded waves-effect waves-light" name="search" value="Search" type="submit" onclick="get_local();">
         <a href="#"><input class="btn btn-white-1 btn-custom btn-rounded waves-effect waves-light" name="clear" value="Reset" type="reset" onclick="reset_all();"></a></div>
         </div>
