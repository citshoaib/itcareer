...
mysql_query("insert into sebna_profile_tbl (reg_id,first_name,last_name,city,Country,state,postal_code,you_are,employment_type,work_authorization,job_title,comapnay,start_date,end_date,current,skill_name,year_exp,last_used,reg_date)
            values('$reg_id','$first_name','$last_name','$city','$Country','$state','$postal_code','$you_are','$employment_type','$work_authorization','$job_title','$comapnay','$start_date','$end_date','$current_date','$skill_name','$year_exp','$last_used','$reg_date')")  or die(mysql_error()); 
