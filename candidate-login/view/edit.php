...
<?php
   ...
   $fetch=$select->fetch_array();
    ...
    $preferred_location=explode(",",$fetch2['preferred_location']);
...
<div class="row">
    <div class="col-lg-12">
   <div class="col-md-6">
      <h3 class="block-head">Edit Your Profile</h3>
   </div>
<div class="col-md-6">
    <div class="act_as fr">
        <h3>
            <a href="../candidate-login/upload_doc/<?php echo $cv_name;?>" download="" style="color: #0C481A;font-weight: bolder;">Download CV</a></h3>
    </div>
</div>
</div>
      ...
      <form action="model/edit_model.php" id="theform" method="post" enctype="multipart/form-data">
         <div class="row">
            <div class="col-md-4 unit">
                <input type="text" name="position" placeholder="Desired Position"  value="<?php echo $position; ?>" class="form-control <?php if($position!=''){ echo 'edited';} ?>" >

            </div>
            <div class="col-md-4 unit">
               <div class="input">
                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                     <input type="text" name="first_name" placeholder="First Name" value="<?php echo $first_name; ?>" class="alphaonly form-control <?php if($first_name!=''){echo 'edited'; } ?>" >
            ...
            <div class="col-md-4 unit">
               <div class="input">
                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                     <input type="text"  placeholder="Middel Name"  value="<?php echo ucfirst($middel_name); ?>" class="alphaonly form-control <?php if($middel_name!=''){echo 'edited'; } ?>" name="middel_name">   
                  </div>
               </div>
            </div>
<div class="col-md-4 unit">
   ...
   if($profile_image!=''){
       ?>
       <img alt="" src="upload_doc/profile_picture/<?php echo $profile_image;?>" style="width: 360px;height: 200px;">
       <?php
   }else{
   ?>
   <img alt="" src="upload_doc/profile_picture/dummy_img.jpg" style="width: 385px;height: 200px;">
   <?php
   }
   ?>
...
<input type="hidden" name="recent_image" value="<?php echo $profile_image;?>">
...
<span style="color: red;">(Only .jgp . png . jpeg)</span></div>
            ...
            <div class="col-md-4 unit">
               <div class="input">
                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                     <input type="text" placeholder="Last Name"  name="last_name" value="<?php echo $last_name; ?>" class="alphaonly form-control <?php if($last_name!=''){echo 'edited'; } ?>" >
                  </div>
               </div>
            </div>
            <div class="col-md-4 unit">
               <div class="input">
                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                     <input type="text" readonly name="email" placeholder="Email"  value="<?php echo $email; ?>" class="form-control <?php if($email!=''){echo 'edited'; } ?>">
                  </div>
               </div>
            </div>
            <div class="col-md-4 unit">
               <div class="input" id="country" style="margin-right: 14px;margin-left: -15px;">
            ...
            <div class="col-md-4 unit">
               <div class="input" id="state" style="margin-right: 14px;margin-left: -15px;">
            ...
            <div class="col-md-4 unit">
               <div class="input">
                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                     <input type="text" name="city" id="city" placeholder="City"   value="<?php echo $city; ?>" class="alphaonly form-control <?php if($city!=''){echo 'edited'; } ?>">
                  </div>
               </div>
            </div>
             <div class="col-md-4 unit">
               <div class="input">
                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                     <input type="text" name="contact"  placeholder="Phone No."  value="<?php echo $phone; ?>" onkeypress="return isNumber(event);" minlength="10" maxlength="10" class="form-control <?php if($phone!=''){echo 'edited'; } ?>" >
                  </div>
               </div>
            </div>
            <div class="col-md-4 unit">
               <div class="input">
                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                     <input type="text"  name="postal_code" placeholder="Zipcode"  id="postal_code" onkeypress="return isNumber(event);" onblur="zip_id(this.value)" value="<?php echo $postal_code; ?>" class="form-control <?php if($postal_code!=''){echo 'edited'; } ?>" >
                  </div>
               </div>
            </div>
             <div class="col-md-4 unit">
         ...
         <div class="row">
            ...
            <div class="col-md-3 unit">
               <div class="input">
                  ...
                  <select name="gender" class="form-control">
                     ...
                     <option <?php if($gender=='other'){?> selected="selected"<?php }?> value="other">Prefer not to say</option>
                    </select>
                  </div>
                </div>
             </div>
            ...
            <div class="col-md-3 unit">
               <label class="col-md-3">Employer Type:</label>
            ...
            <div class="col-md-3 unit">
               <label class="col-md-3">Work Type:</label>
               <div class="input col-md-9">
                  <select class="form-control"  name="emp_type">
                     <option >Select type </option>
                    <option <?php if($emp_typ=='wfo'){?> selected="selected"<?php }?> value="wfo" >Work From Office </option>
                     <option <?php if($emp_typ=='wfh'){?> selected="selected"<?php }?> value="wfh" >Work From Home </option>
                     <option <?php if($emp_typ=='hy'){?> selected="selected"<?php }?> value="hy">Hybrid </option>
                  </select>
               </div>
            </div>
         </div>
         ...
         <div  id="work_authorization_id_12">
            ...
            <div class="row">
               <div class="col-md-4 unit">
               <label class="col-md-3">Current Salary:</label>
                  <div class="input col-md-9">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="salary"  placeholder="Annual Salary" value="<?php echo $salary; ?>" style="margin-left: -10px;" class="form-control <?php if($salary!=''){ echo 'edited';} ?>">
                     </div>
                  </div>
               </div>
            <div class="col-md-4 unit">
               ...
               <div class="input col-md-9">
                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="hourly_rate" placeholder="Expected Salary"  value="<?php echo $hourly_rate; ?>" class="form-control <?php if($hourly_rate!=''){ echo 'edited';} ?>">
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
                <div class="col-md-5 unit">
                  ...
                  <div class="input col-md-10">
                     <?php
                        foreach ($preferred_location as $key => $preferred_location1) {
                        ?>
                     <div class='row remove_row_<?php echo $key;?>'>
                        <div class='input col-md-4'>
                           <div class='form-group form-md-line-input form-md-floating-label has-success'>
                              <input type='text' name='preferred_location[]'  value='<?php echo $preferred_location1;?>' class='form-control <?php if($preferred_location!=''){echo 'edited'; } ?> language_field'>
                           </div>
                        </div>
                        <div class='input col-md-4'>
                           <div class='form-group form-md-line-input form-md-floating-label has-success'>
                              <a class=" remove" onclick="language_remove_pre('<?php echo $key;?>');" href="javascript:void(0);"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a>
                           </div>
                        </div>
                     </div>
                     <?php } ?>
                     <div id="append_language_pre">
                     </div>
                     <!--    <div class="input col-md-3">-->
                     <!--</div>-->
                     <div class="col-md-12 unit">
                        <input style="margin-left: -14px;" class="btn btn-primary btn-lg" id="add_button_pre" style="padding: 6px 12px;" value="Add" type="button">
                     </div>
                     <div class="cl"></div>
                  </div>
               </div>
               ...
               <label class="col-md-6">Relocate:</label>
               <div class="input col-md-6">
                  <div class="fl">
                     <input type="checkbox" name="relocate"  value="yes" data-toggle="toggle" <?php if($relocate!=''){ echo "checked"; } ?>>
                  </div>
               </div>
                <label class="col-md-5">Searchable:</label>   
                  <div class="fl">
                     <div class="col-md-10 unit" style="float: right;"><input type="checkbox" name="searchable" value="yes"  data-toggle="toggle" <?php if($searchable!=''){ echo "checked"; } ?> ></div>
            ...
            <fieldset>
               ...
               <div class="row" id="skill_<?php echo $kk;?>">
                  <div class="input col-md-3">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="skill_name[]" id="skill_name_<?php echo $kk;?>" class="form-control <?php if($skill_row["skill_name"]!=''){echo 'edited'; } ?>" placeholder="Skill" value="<?php echo $skill_row['skill_name']; ?>" >
                        
                     </div>
                  </div>
                  <div class="col-md-3">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="year_exp[]" id="year_exp_<?php echo $kk;?>" class="form-control <?php if($skill_row["year_exp"]!=''){echo 'edited'; } ?>" placeholder='Yrs Exp' value="<?php echo $skill_row['year_exp'];?>" >
                        
                     </div>
                  </div>
                  <div class="col-md-3">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="last_used[]" id="last_used_<?php echo $kk;?>" class="form-control <?php if($skill_row["last_used"]!=''){echo 'edited'; } ?>" place="Last Used" value="<?php echo $skill_row['last_used'];?>" >
               ...
               <div class="row" id="skill_<?php echo $kk;?>">
                  <div class="input col-md-3">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="skill_name[]" id="skill_name_<?php echo $kk;?>" class="form-control <?php if($skill_row["skill_name"]!=''){echo 'edited'; } ?>" placeholder="Skill" value="<?php if(isset($skill_row['skill_name'])){ echo $skill_row['skill_name']; } ?>" >
                        
                     </div>
                  </div>
                  <div class="col-md-3">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="year_exp[]" id="year_exp_<?php echo $kk;?>" class="form-control <?php if($skill_row["year_exp"]!=''){echo 'edited'; } ?>" placeholder="Yrs Exp" value="<?php if(isset($skill_row['year_exp'])){ echo $skill_row['year_exp']; } ?>" >
                        
                     </div>
                  </div>
                  <div class="col-md-3">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="last_used[]" id="last_used_<?php echo $kk;?>" class="form-control <?php if($skill_row["last_used"]!=''){echo 'edited'; } ?>" placeholder="Last Used" value="<?php if(isset($skill_row['last_used'])){ echo $skill_row['last_used']; } ?>" >
            ...
            <fieldset>
               ...
               <div class="row <?php echo $idwk; ?>">
                  <div class="col-md-12 unit">
                     ...
                     <div class="input">
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                           <input type="text" name="job_title[]" value="<?php if(isset($fetch_work_experience['job_title'])) { echo $fetch_work_experience['job_title']; } ?>" placeholder="Job Title" class="job_title form-control <?php if($fetch_work_experience['job_title']!=''){echo 'edited'; } ?> " >
                  ...
                  <div class="col-md-12 unit">
                     <div class="input">
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                           <input type="text" name="comapnay[]" value="<?php if(isset($fetch_work_experience['comapnay'])) { echo $fetch_work_experience['comapnay']; } ?>" placeholder="Company" class="comapnay form-control <?php if($fetch_work_experience['comapnay']!=''){echo 'edited'; } ?>" >
                  ...
                  <div class="col-md-3 unit">
                     <div class="input">
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                           <input type="text" name="start_date[]" placeholder="Start Date" value="<?php if(isset($fetch_work_experience['start_date'])) { echo $fetch_work_experience['start_date']; } ?>" class="start_date form-control demo-1 <?php if($fetch_work_experience['start_date']!=''){echo 'edited'; } ?>" >
                  ...
                  <div class="col-md-3 unit">
                     <div class="input">
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                           <input type="text" name="end_date[]" placeholder="End Date" value="<?php if(isset($fetch_work_experience['end_date'])) { echo $fetch_work_experience['end_date']; } ?>" class="end_date form-control demo-1 <?php if($fetch_work_experience['end_date']!=''){echo 'edited'; } ?>" >
                  ...
                  <div class="col-md-3 unit pt_10">
                     <div class="input">
                        <input type="radio" name="current[]" <?php echo ($fetch_work_experience['current']!='' )?'checked':'';  ?>  value="<?php if(isset($current_date)) { echo $current_date; } ?>"  class="ng-pristine ng-valid current">   Current 
                     </div>
                  </div>
               ...
               <div class="row work_experience">
                  <div class="col-md-12 unit">
                     ...
                     <div class="input">
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                           <input type="text" name="job_title[]" placeholder="Job Title" value="<?php if(isset($fetch_work_experience['job_title'])){ echo $fetch_work_experience['job_title']; } ?>" class="job_title form-control" >
                  ...
                  <div class="col-md-12 unit">
                     <div class="input">
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                           <input type="text" name="comapnay[]" placeholder="Company" value="<?php if(isset($fetch_work_experience['comapnay'])) { echo $fetch_work_experience['comapnay']; } ?>" class="comapnay form-control" >
                  ...
                  <div class="col-md-3 unit">
                     <div class="input">
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                           <input type="text" name="start_date[]" placeholder="Start Date" value="<?php if(isset($fetch_work_experience['start_date'])) { echo $fetch_work_experience['start_date']; } ?>" class="start_date form-control demo-1" >
                  ...
                  <div class="col-md-3 unit">
                     <div class="input">
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                           <input type="text" name="end_date[]" placeholder="End Date" value="<?php if(isset($fetch_work_experience['end_date'])) { echo $fetch_work_experience['end_date']; } ?>" class="end_date form-control demo-1" >
                  ...
                  <div class="col-md-3 unit pt_10">
                     <div class="input">
                        <input type="radio" name="current[]" value="<?php echo $current_date; ?>"  class="ng-pristine ng-valid current">   Current 
                     </div>
                  </div>
               </div>
            ...
            <fieldset>
               ...
               <div class="row" id="edu_<?php echo $kk;?>">
                  ...
                  <div class="input col-md-2">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="institution[]" id="institution_<?php echo $kk;?>" class="form-control <?php if($edu_row["institution"]!=''){echo 'edited'; } ?>" placeholder="Institute" value="<?php if(isset($edu_row['institution'])){ echo $edu_row['institution']; }?>" >
                        
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="edu_city[]" id="edu_city_<?php echo $kk;?>" class="form-control <?php if($edu_row["city"]!=''){echo 'edited'; } ?>" placeholde="City/ST" value="<?php if(isset($edu_row['city'])){ echo $edu_row['city']; } ?>" >
                  ...
                  <div class="col-md-2">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="edu_year[]" id="year_<?php echo $kk;?>" class="form-control <?php if($edu_row["year"]!=''){echo 'edited'; } ?>" placeholder="Year" value="<?php if(isset($edu_row['year'])){ echo $edu_row['year']; } ?>" >
               ...
               <div class="row" id="edu_<?php echo $kk;?>">
                  ...
                  <div class="col-md-2">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="text" name="edu_city[]" id="edu_city_<?php echo $kk;?>" class="form-control <?php if($edu_row["city"]!=''){echo 'edited'; } ?>" placeholder="City/ST" value="<?php if(isset($edu_row['city'])){ echo $edu_row['city']; } ?>" >
            ...
            <fieldset>
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="form-group form-md-line-input form-md-floating-label has-success">
                        <input type="url" name="social_media_url[]" id="social_media_url_<?php echo $kk;?>" class="form-control <?php if($media_row["media_url"]!=''){echo 'edited'; } ?>" placeholder="URL" value="<?php if(isset($media_row['media_url'])) { echo $media_row['media_url']; } ?>" >
...
<script>
   $("#add_button_pre").click(function(){
     
    
     lang_field=$("#language").val();
     if(lang_field!==""){
         
         $("#append_language_pre").append("<div class='row'><div class='input col-md-4'><div class='form-group form-md-line-input form-md-floating-label has-success'><input type='text' name='preferred_location[]'  value='' class='form-control <?php if($preferred_location!=''){echo 'edited'; } ?> language_field'></div></div><div class='input col-md-4'><div class='form-group form-md-line-input form-md-floating-label has-success'><a class='remove_r remove' href='javascript:void(0);'><i class='fa fa-minus-circle'></i> Remove</a></div></div></div>");
     ...
     function language_remove_pre(val){
...
<script>
   $("#add_button").click(function(){
     ...
     if(lang_field!==""){
         ...
         $("#append_language").append("<div class='row'><div class='input col-md-4'><div class='form-group form-md-line-input form-md-floating-label has-success'><input type='text' name='language[]'  value='' class='form-control <?php if($language!=''){echo 'edited'; } ?> language_field'></div></div><div class='input col-md-4'><div class='form-group form-md-line-input form-md-floating-label has-success'><a class='remove_r remove' href='javascript:void(0);'><i class='fa fa-minus-circle'></i> Remove</a></div></div></div>");
...
<script>
   ...
   if($len<=4)
   $("#append_skill").append('<div class="row" id="skill_'+$len+'"><div class="input col-md-3"><div class="form-group form-md-line-input form-md-floating-label has-success"><input type="text" name="skill_name[]" placeholder="Skill" id="skill_name_'+$len+'" class="form-control" ></div></div><div class="col-md-3"><div class="form-group form-md-line-input form-md-floating-label has-success"><input type="text" name="year_exp[]" id="year_exp_'+$len+'" class="form-control" placeholder="Yrs Exp"></div></div><div class="col-md-3"><div class="form-group form-md-line-input form-md-floating-label has-success"><input type="text" name="last_used[]" placeholder="Last Used" id="last_used_'+$len+'" class="form-control" ></div></div><div class="col-md-2"><a class=" remove" onclick="return removeeee_skill('+$len+');" href="javascript:void(0);"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a></div></div>');
   }
