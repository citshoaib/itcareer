...
// nl2br($extracted_plaintext);
        ...
        <iframe width="100%" height="500px" id="file_name"  class="doc" src="https://view.officeapps.live.com/op/view.aspx?src=http://develop-a.cheshtainfotech.com/sedna/TL/fileUpload/'.$new_file_name.'"></iframe>
        </div>
        ';
