...
//                move_uploaded_file($_FILES['cv']['tmp_name'],$real_upload_name_move);
//		  $inputFileName = $real_upload_name;
//          mysql_query("insert into sedna_operator_request_consultants_reg (operator_id,email,cv,date,status) values('admin','$email','$real_upload_name','$date_for_upload_name','1')") or die(mysql_error());
//
...
<div class="row">
     ...
     <form action="model/create_model.php" method="post">
        <div class="row">
                       ...
                       <div class="row">
                            <div class="col-md-4 unit">
                              ...
                              <div class="form-group form-md-line-input form-md-floating-label has-success">
                                    ...
                                    <input type="text"  value="<?php echo ucfirst($first_name); ?>" class="alphaonly form-control <?php if($first_name!=''){echo 'edited'; } ?>" name="first_name">   <label for="form_control_1">First Name</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 unit">
                                ...
                                <div class="input">
                                <div class="form-group form-md-line-input form-md-floating-label has-success">
                                    <input type="text"  value="<?php echo ucfirst($last_name); ?>" class="alphaonly form-control <?php if($last_name!=''){echo 'edited'; } ?>" name="last_name">
	  ...
	  <label for="form_control_1">City</label>
                                ...
                                <!--<div class="input">
                                 <div class="form-group form-md-line-input form-md-floating-label has-success">
                                    <input type="text" id="city"  class="alphaonly form-control" name="city" onblur="city_name(this.value)">
                                    <label for="form_control_1">City</label>
                                    </div>
                                </div>-->
                            </div>
							<div class="col-md-4 unit">
                                ...
                                <div class="input">
                                 <div class="form-group form-md-line-input form-md-floating-label has-success">
                                    <input type="text" id="postal_code"  class="form-control" onkeypress="return isNumber(event);" name="postal_code" onblur="zip_id(this.value)">
...
//						 });
            ...
            <div class="col-md-12 unit">
                        ...
                        <div class="col-md-12 unit">
                                ...
                                <div class="input">
                                  <div class="form-group form-md-line-input form-md-floating-label has-success">
                                    <input type="text"  class="form-control" name="comapnay[]">
                                     <label for="form_control_1">Company</label>
                                    </div>
                                </div>
                            </div>
              ...
              <div class="col-md-3 unit">
                                ...
                                <div class="input">
                                 <div class="form-group form-md-line-input form-md-floating-label has-success">
								    ...
								    <input type="text" id=""  class="form-control demo-1" name="start_date[]">
