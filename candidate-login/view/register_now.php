...
<div class="signup-form">
    <form action="model/candidate_create_model.php" method="post">
 ...
 <div class="container">
     <div class="panel">
       ...
       ?>
        ...
        <div class="form-group">
        	<input type="email" class="form-control" name="can_email" placeholder="Email" required="required">
        </div>
        ...
        <div class="form-group">
            <textarea cols="5" placeholder="Address" name="address" class="form-control" rows="5"></textarea>
        </div>        
