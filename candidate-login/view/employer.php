...
//ini_set('display_startup_errors', TRUE);
		...
		$keyword_search=search_candidate($keyword_set,'f.resume_data',$keyword_string);
...
//        }
		...
		$select_city_zip=mysql_query("select min(zip_code) as zip_code from zip_code where city like '%". $work_country . "%' ");
     ...
     $total_rows=mysql_num_rows($query12);
        ...
        $query123="SELECT a.date,a.id,a.email,b.reg_id,b.first_name,b.middel_name,b.phone_no,b.state,b.city,b.postal_code,b.employment_type,b.work_authorization,b.comment,b.relocate,b.security,b.searchable,b.last_name,b.salary,b.hourly_rate,b.experience,b.position,e.comapnay,
