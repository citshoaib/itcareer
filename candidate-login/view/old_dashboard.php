	  ...
	  <?php
	  $select_oprater=mysql_query("SELECT distinct operator_id  FROM sedna_operator_request_consultants_reg  WHERE STATUS = '1' and operator_id !='admin' and operator_id !=''");
	  $count_row=mysql_num_rows($select_oprater);
	  while($fetch_oprater=mysql_fetch_array($select_oprater))
	  {
	  $operator_id= $fetch_oprater['operator_id'];
	  $select_oprater1_name=mysql_query("SELECT * FROM sedna_user_registration_tbl  WHERE id=$operator_id ");
	  $fetch_oprater112_name=mysql_fetch_array($select_oprater1_name);
	   $fetch_oprater112_name['name'];
	  $select_oprater1=mysql_query("SELECT * FROM sedna_operator_request_consultants_reg  WHERE operator_id=$operator_id ");
	   $num_of_consultants2_oprater1= mysql_num_rows($select_oprater1); 
	  $fetch_oprater112=mysql_fetch_array($select_oprater1);
